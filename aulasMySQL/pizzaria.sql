...
("Nutella", "Nutella, Pedaços de chocolate",60,1),
("4 queijos", "Mussarela, Parmesão, Gorgonzola, Provolone", 82.90,2),
("Chocolate Branco", "Chocolate Branco",50,1),
("Frango com Catupiry", "Frango, Catupiry",70,2),
("Catupiry", "Mussarela, Catupiry",40,3),
